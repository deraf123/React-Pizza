...
import { selectCartItemById } from '../../redux/slices/cartSlice/selector';
...
export const PizzaBlock: React.FC<PizzaBlockProps> = ({
  ...
  const clickActiveType = (id: number) => {
    setActiveType(id);
  };
  const clickActiveSize = (id: number) => {
    setActiveSize(id);
  };
  const onAddItem = () => {
    const item: CartItem = {
